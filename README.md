...
# 🟣 PocketFi AutoBot /// HPV /// V3.01 🟣

| **Возможности**                                                    | **Поддерживается**  |
|----------------------------------------------------------------|:---------------:|
| **Многофункциональный** — *автоматизирует действия, которые вы обычно выполняете вручную:*<br>**—** *Получение ежедневной награды*;<br>**—** *Выполнение задания с подпиской на Telegram и Twitter*;<br>**—** *Сбор монет*;<br>**—** *Ожидание от 8 до 11 часов*;<br>**—** *Повторение действий через 8-11 часов.<br>Все действия выполняются в случайном порядке каждый раз, когда скрипт начинает сбор. Также добавлена пустая функция просмотра привязанного кошелька и список рефералов для большей правдоподобности* |✅|
...
- **Linux**
  ...
  - ```
    ...
    ```
  - ```
    git clone https://github.com/HPV-CLOUD/PocketFi
    ```
  - ```
    pip3 install HPV_TEAM_PocketFi
    ```
- **Windows**
